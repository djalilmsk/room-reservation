          ...
          render={({ field }) => (
            <FormItem>
              <div className="relative mx-auto flex w-full max-w-xl cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed p-6">
                {isLoading ? (
                  <div role="status" className="flex flex-col items-center justify-center gap-3 my-3">
                    <svg
                      aria-hidden="true"
                      class="inline h-8 w-8 animate-spin fill-secondary-foreground text-muted-foreground "
                      viewBox="0 0 100 101"
                      fill="none"
